...
final class AppFactory
{
    public static function register(App $app): void
    {
        ...
        $app->group('/api/v1', function (RouteCollectorProxy $group) use ($container) {
            ...
            $group->post('/public-admissions/edit-otp/request', [ErpController::class, 'requestPublicAdmissionEditOtp']);
            $group->post('/public-admissions/edit-otp/verify', [ErpController::class, 'verifyPublicAdmissionEditOtp']);
            $group->get('/public-admissions/{id}', [ErpController::class, 'findPublicAdmissionById']);
            $group->get('/public-admissions/by-aadhar/{aadhar:[0-9]{12}}', [ErpController::class, 'findPublicAdmissionByAadhar']);
            $group->get('/documents/verify/{id}', [ErpController::class, 'verifyPublicDocument']);
            $group->get('/admission-masters', [ErpController::class, 'publicAdmissionMasters']);
            $group->get('/public-subject-selection', [ErpController::class, 'publicSubjectSelection']);
            ...
            $group->get('/transliterate', function ($request, $response) {
                $query = $request->getQueryParams();
                $lang = trim((string) ($query['lang'] ?? 'mr'));
                ...
                $url = sprintf(
                    'https://inputtools.google.com/request?itc=%s-t-i0-und&num=5&cp=0&cs=1&ie=utf-8&oe=utf-8&app=demopage&text=%s',
                    rawurlencode($lang),
                    rawurlencode($text)
                );
                ...
                if (!is_string($raw) || $raw === '') {
                    $raw = @file_get_contents($url, false, stream_context_create([
                        'ssl' => ['verify_peer' => false, 'verify_peer_name' => false],
                        'http' => ['timeout' => 12, 'header' => "User-Agent: CampusSuite/1.0\r\n"],
                    ]));
                }
                ...
                $response->getBody()->write(json_encode([
                    'data' => array_slice($suggestions, 0, 5),
            ...
            $group->group('/admin', function (RouteCollectorProxy $admin) {
                ...
                $admin->get('/erp/student-portal', [ErpController::class, 'studentPortal']);
                $admin->post('/erp/student-portal/photo', [ErpController::class, 'uploadStudentPhoto']);
                $admin->post('/erp/student-portal/documents', [ErpController::class, 'uploadStudentPortalDocument']);
                ...
                $admin->get('/erp/admissions/{id:[0-9]+}/audit', [ErpController::class, 'admissionAudit']);
                ...
                $admin->post('/erp/admissions/{id:[0-9]+}/documents/upload', [ErpController::class, 'uploadAdmissionDocument']);
                ...
                $admin->put('/erp/users/{id:[0-9]+}', [ErpController::class, 'updateUser']);
                $admin->get('/erp/email-settings', [ErpController::class, 'emailSettings']);
                $admin->put('/erp/email-settings', [ErpController::class, 'saveEmailSettings']);
                ...
                $admin->delete('/erp/masters/classes/{id:[0-9]+}', [ErpController::class, 'deleteMasterClass']);
                $admin->post('/erp/masters/courses', [ErpController::class, 'saveMasterCourse']);
                $admin->delete('/erp/masters/courses/{id}', [ErpController::class, 'deleteMasterCourse']);
                $admin->post('/erp/masters/academic-years', [ErpController::class, 'saveAcademicYear']);
                $admin->post('/erp/masters/sections', [ErpController::class, 'saveMasterSection']);
                  ...
                  $admin->post('/erp/masters/course-subject-plan', [ErpController::class, 'saveCourseSubjectPlan']);
                  $admin->post('/erp/masters/class-subject-plan', [ErpController::class, 'saveClassSubjectPlan']);
                  $admin->get('/erp/subjects/setup', [ErpController::class, 'subjectSetup']);
                  $admin->post('/erp/subjects/papers', [ErpController::class, 'saveSubjectPapers']);
                  $admin->post('/erp/subjects/course-year-groups', [ErpController::class, 'saveCourseYearSubjectGroups']);
                  $admin->post('/erp/subjects/course-year-group-subjects', [ErpController::class, 'saveCourseYearGroupSubjects']);
                  ...
                  $admin->post('/erp/students/import', [ErpController::class, 'importExistingStudents']);
                  $admin->post('/erp/students/promote', [ErpController::class, 'promoteExistingStudent']);
                ...
                $admin->post('/erp/finance/documents/tc/original-print', [ErpController::class, 'markTcOriginalPrinted']);
                $admin->post('/erp/finance/fee-heads', [ErpController::class, 'createFeeHead']);
                $admin->delete('/erp/finance/fee-heads/{id:[0-9]+}', [ErpController::class, 'deleteFeeHead']);
                $admin->post('/erp/finance/fee-categories', [ErpController::class, 'saveFeeCategoryMatrix']);
                $admin->get('/erp/scholarships', [ErpController::class, 'scholarships']);
                $admin->post('/erp/scholarships/forms', [ErpController::class, 'saveScholarshipForm']);
                $admin->post('/erp/scholarships/receive', [ErpController::class, 'receiveScholarshipPayment']);
                $admin->post('/erp/finance/class-fees', [ErpController::class, 'assignClassFees']);
                $admin->post('/erp/finance/expenses', [ErpController::class, 'createExpense']);
                $admin->get('/erp/hr', [ErpController::class, 'hr']);
                $admin->post('/erp/hr/departments', [ErpController::class, 'saveDepartment']);
                $admin->post('/erp/hr/employees', [ErpController::class, 'saveEmployee']);
                $admin->post('/erp/hr/leave-categories', [ErpController::class, 'saveLeaveCategory']);
                $admin->post('/erp/hr/leaves', [ErpController::class, 'applyLeave']);
                $admin->put('/erp/hr/leaves/{id:[0-9]+}/review', [ErpController::class, 'reviewLeave']);
                $admin->post('/erp/hr/salary-structures', [ErpController::class, 'saveSalaryStructure']);
                $admin->post('/erp/hr/salary-slips', [ErpController::class, 'generateSalarySlip']);
